package com.tlyong1992.ribbon;

import com.tlyong1992.service.impl.RibbonServiceImpl;
...
public class RibbonController {
    ...
    public String hello(){
        return  restTemplate.getForEntity("http://chat-EUREKA-CLIENT/hi?name=Ribbon",String .class).getBody();
    }
